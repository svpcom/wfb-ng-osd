...
osd_params_t osd_params = {
    ...
    .BattCurrent_panel=1,
    .BattCurrent_posX=65,
    .BattCurrent_posY=240,
    .BattCurrent_fontsize=0,
    .BattCurrent_align=0,
    .BattRemaining_en=1,
    .BattRemaining_panel=1,
    .BattRemaining_posX=10,
    .BattRemaining_posY=230,
    ...
    .CWH_Nmode_posY=40,
    .CWH_Nmode_radius=20,
    .CWH_Nmode_home_radius=25,
    .CWH_Nmode_wp_radius=25,
    .Atti_mp_en=1,
    .Atti_mp_panel=1,
    .Atti_mp_mode=0,
    .Atti_3D_en=1,
    ...
    .Vario_Graph_panel=0,
    .Vario_Graph_posX=200,
    .Vario_Graph_posY=200,
